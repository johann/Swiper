 ...
 */
- (NSError *)updateFirmware:(KTKFirmware *)firmware usingMasterPassword:(NSString *)masterPassword progressHandler:(void (^)(KTKBeaconDeviceFirmwareUpdateState state, float progress))progressHandler;
